	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>用户账号</label>
					<input name="yonghuzhanghao" readonly id="yonghuzhanghao" name="yonghuzhanghao" class="form-control" placeholder="请输入用户账号">
				</div>
				<div class="form-item">
					<label>用户姓名</label>
				...
				<div class="form-item">
					<label>会员等级</label>
					<select  class="form-control" disabled="disabled"  name="huiyuandengji" id="huiyuandengjiSelect" onchange="huiyuandengjiSelect2Change()">
					</select>
				</div>
				<div class="form-item">
					<label>会员折扣</label>
