...
<html>
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"padding":"0px","margin":"0 auto","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#333","width":"100%","position":"relative","height":"44px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 0 0 180px","color":"#fff","textAlign":"left","background":"none","width":"calc(100% - 360px)","lineHeight":"44px","fontSize":"18px","height":"44px"}' class="nav-top-title">{{projectName}}</div>
			<div :style='{"width":"180px","margin":"0","alignItems":"center","display":"flex"}'>
				<div :style='{"color":"#666","fontSize":"14px","display":"inline-block"}'></div>
				<button v-if="!Token" :style='{"border":"0px solid #ffc303","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#fff","borderRadius":"0px","background":"#288bbf","display":"inline-block","fontSize":"14px","lineHeight":"30px","height":"30px"}' @click="jumpLogin('./pages/login/login.jsp')">登录/注册</button>
				<button v-if="Token" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#666","borderRadius":"0px","background":"#fff","display":"inline-block","fontSize":"14px","lineHeight":"30px","height":"30px"}' @click="logout()">退出</button>
			</div>
		</div>
		
		
		<!-- 横向 -->
		<div id="navs" class="horizontal" :style='{"width":"100%","padding":"0","margin":"0px auto 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat","height":"auto"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":"0","padding":"0px","listStyle":"none","margin":"0","textAlign":"center","background":"none","width":"100%","lineHeight":"80px","position":"relative","zIndex":"11","height":"80px"}'>
		...
		<div id="tabbar" class="tabbar" :style='{"padding":"50px 50px 0","margin":"0 auto","alignItems":"center","background":"#333","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"150px"}'>
