...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="yonghuzhanghao"  placeholder="请输入用户账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  name="yonghuxingming"  placeholder="请输入用户姓名" class="form-control-i">
				</div>
                <div class="list-item">
				...
				<div class="list-item">
					<input  name="yonghushouji"  placeholder="请输入用户手机" class="form-control-i">
				</div>
