...
public class BaojianxinxiController {
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<BaojianxinxiEntity> ew = new EntityWrapper<BaojianxinxiEntity>();
        List<Map<String, Object>> result = baojianxinxiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<BaojianxinxiEntity> ew = new EntityWrapper<BaojianxinxiEntity>();
        List<Map<String, Object>> result = baojianxinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<BaojianxinxiEntity> ew = new EntityWrapper<BaojianxinxiEntity>();
        List<Map<String, Object>> result = baojianxinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,BaojianxinxiEntity baojianxinxi, HttpServletRequest request){
        EntityWrapper<BaojianxinxiEntity> ew = new EntityWrapper<BaojianxinxiEntity>();
        int count = baojianxinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, baojianxinxi), params), params));
