				...
				<div :style='{"padding":"0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","margin":"0","display":"flex","justifyContent":"space-between","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","position":"relative","borderStyle":"solid"}'>
					...
					<div :style='{"minHeight":"540px","padding":"0 0 40px","margin":"20px 7% 0","borderColor":"#eee","background":"url(http://codegen.caihongy.cn/20230127/03ad723288d44044a8b922de0a51127f.png) no-repeat left top,url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat center bottom,#e0edf2","borderWidth":"0px","flex":"1","width":"100%","borderStyle":"solid","order":"1"}'>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>包间类型：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.baojianleixing}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>容纳人数：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.rongnarenshu}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>使用时长：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.shiyongshizhang}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>费用：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.feiyong}}
							</div>
						</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>预订时间：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.yudingshijian}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>备注：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.beizhu}}
							</div>
						</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`baojianyuding`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
					vue.title = vue.detail.fangjianhao;
					// 轮播图
					vue.$nextTick(() => {
						carousel.render({
							elem: '#swiper',
