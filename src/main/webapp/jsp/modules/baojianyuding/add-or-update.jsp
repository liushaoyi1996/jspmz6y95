...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑包间预订</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑包间预订</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>包间类型</label>
					<input name="baojianleixing" id="baojianleixing" name="baojianleixing" class="form-control" placeholder="请输入包间类型">
				</div>
				<div class="form-item">
					<label>容纳人数</label>
				...
				<div class="form-item">
					<label>费用</label>
					<input id="feiyong" name="feiyong" class="form-control" onchange="calculation()" placeholder="请输入费用">
				</div>
				<div class="form-item">
					<label>用户账号</label>
				...
				<div class="form-item">
					<label>预订时间</label>
					<input id="yudingshijian-input" class="date" name="yudingshijian" size="15" type="text" readonly placeholder="请选择预订时间">
				</div>
				<div class="form-item">
					<label>备注</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "baojianyuding/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("baojianyuding/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("baojianyuding/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#yudingshijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculation(){
			...
			if($("#feiyong").val() != null && $("#feiyong").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#feiyong").val());
					flag++;
				}else{
					x = x * parseFloat($("#feiyong").val());
					flag++;
				}
			}
		...
		function dataBind(){
			...
			$("#baojianleixing").val(ruleForm.baojianleixing);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.baojianleixing != null && res.data.baojianleixing != ''){
						...
						$("#baojianleixing").val(res.data.baojianleixing);
						$("#baojianleixing").attr('readonly','readonly');
					}
