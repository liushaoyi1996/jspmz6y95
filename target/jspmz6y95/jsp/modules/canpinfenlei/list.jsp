...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">餐品分类管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>餐品分类管理</span></li>
				<li class="breadcrumb-item-two"><span>餐品分类列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>餐品分类</label>
					<input type="text" id="canpinfenleiSearch" class="form-control form-control-sm" placeholder="请输入餐品分类" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#canpinfenleiSearch').val() != null && $('#canpinfenleiSearch').val() != ''){
				searchForm.canpinfenlei ="%" +  $('#canpinfenleiSearch').val() + "%";
			}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("canpinfenlei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"canpinfenlei");
