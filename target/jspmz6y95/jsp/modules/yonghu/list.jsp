...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">用户管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>用户列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>会员等级</label>
					<input type="text" id="huiyuandengjiSearch" class="form-control form-control-sm" placeholder="请输入会员等级" aria-controls="tableId">
				</div>
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('会员等级统计')"><i class="fa fa-database"></i><span>会员等级统计</span></button>
			</div>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="huiyuandengjiMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
	...
	<script>
		...
		function search(){
			...
			if($('#huiyuandengjiSearch').val() != null && $('#huiyuandengjiSearch').val() != ''){
				searchForm.huiyuandengji ="%" +  $('#huiyuandengjiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yonghu/page","GET",{
				...
				huiyuandengji : searchForm.huiyuandengji,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
            ...
            touxiangImg.setAttribute('src',item.touxiang?(baseUrl+item.touxiang.split(",")[0]):'');
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('huiyuandengjiMain1'),'blue');
                                    var option = {};
                                    option = {
                                            title: {
                                                text: '会员等级统计',
